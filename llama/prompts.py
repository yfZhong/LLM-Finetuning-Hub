...
TRAINING_SUMMARIZATION_PROMPT_v3 = """Summarize the following dialogue that is delimited with triple backticks into a medical report having the following sections : "HISTORY OF PRESENT ILLNESS", "PHYSICAL EXAM", "RESULTS", "ASSESSMENT AND PLAN". 

### Dialogue: ```{dialogue}```
### Summary: {summary}
"""
INFERENCE_SUMMARIZATION_PROMPT_v3 = """Summarize the following dialogue that is delimited with triple backticks into a medical report having the following sections : "HISTORY OF PRESENT ILLNESS", "PHYSICAL EXAM", "RESULTS", "ASSESSMENT AND PLAN".
